...
namespace AgriConnect.Web.Data
{
    public class Seeder
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("Brad", "Pitt", "brad.pit@gmail.com", "2222111111", "brad.png", UserType.Provider);
            await CheckUserAsync("Angelina", "Jolie", "angelina.jolie@gmail.com", "2222222222", "angelina.png", UserType.Client);
            await CheckUserAsync("Jennifer", "Lopez", "jlo@gmail.com", "2223333333", "jlo.png", UserType.User);
        ...
        private async Task CheckCitiesAsync()
        {
            if (!dataContext.Cities.Any())
            {
                ...
                dataContext.Cities.Add(new City { Name = "Loma Bonita" });
